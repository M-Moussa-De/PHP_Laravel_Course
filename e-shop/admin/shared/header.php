                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item dropdown d-none d-lg-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item preview-item" href="./pages/products/new.php">
                                    <div class="preview-thumbnail">
                                        <div class="preview-icon bg-dark rounded-circle">
                                    ...
                                    <div class="preview-item-content">
                                        <p class="preview-subject ellipsis mb-1">Add a new product</p>
                                    </div>
                                </a>
                        ...
                        <li class="nav-item dropdown border-left">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="<?= ROOT_PATH . '/assets/images/faces/face4.jpg' ?>" alt="image" class="rounded-circle profile-pic">
                                    </div>
                                    <div class="preview-item-content">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="<?= ROOT_PATH . '/assets/images/faces/face2.jpg' ?>" alt="image" class="rounded-circle profile-pic">
                                    </div>
                                    <div class="preview-item-content">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="<?= ROOT_PATH . '/assets/images/faces/face3.jpg' ?>" alt="image" class="rounded-circle profile-pic">
                                    </div>
                                    <div class="preview-item-content">
